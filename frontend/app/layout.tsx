...
export const metadata: Metadata = {
  title: "GenRights — AI Copyright Licensing on GenLayer",
  description:
    "On-chain content licensing and infringement bounties. Intelligent Contract with web access and AI jury.",
